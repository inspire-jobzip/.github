...
- React를 활용해 공고 조회, 스크랩, 이력서 관리 등 여러 기능을 하나의 일관된 사용자 경험으로 연결

## 만든 사람

| 이름 | 역할 | GitHub |
| --- | --- | --- |
| 김나연 | 프론트엔드 | `https://github.com/duckfairy-wak` |
| 임현 | 백엔드 | `https://github.com/limhyun0319` |
| 정세빈 | 백엔드 / AI | `https://github.com/sebinJeong` |
| 홍정현 | 백엔드 / AI | `https://github.com/jhh6079` |
